...
namespace FridayNightFunkin {
    public class FNFSong {
        private Song.Root dataRoot {
            get;
        }
        public List<FNFSection> Sections {
            get; set;
        }
        ...
        public class FNFSection {
            ...
            public List<FNFNote> Notes {
                get; set;
            }
            public bool MustHitSection {
                get => dataNote.MustHitSection; set => dataNote.MustHitSection = value;
            }
        ...
        public class FNFNote {
            ...
            public FNFNote( decimal time, decimal noteType, decimal length, decimal modType ) {
                Time = time;
            ...
            public decimal ModType {
                get; set;
            } // ModNoteType for Hurt Notes or Etc (only numbers) by raonyreis13
        }
